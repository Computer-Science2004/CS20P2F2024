...
public class BuildaThermostat {
   public static void main(String[] args) throws Exception {
    ...
    while (true) {
        ...
        double currentTemperature = temperatureSensor.getTemperature(); // variable currenTemperature = temp from sensor
        // Check if the green button is pressed to increase the set temperature by 1°C
        if (greenButton.getState()) {
            setTemperature += 1; // Increases the set temperature by 1°C
        }
        // Check if the red button is pressed to decrease the set temperature by 1°C
        if (redButton.getState()) {
            setTemperature -= 1; // Decreases the set temperature by 1°C
        }
...
} // Close public class BuildaThermostat
