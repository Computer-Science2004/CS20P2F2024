...
public class LEDBrightness {
  ...
  public static void main(String[] args) throws Exception{
    ...
    for (double dutyCycle = 0.0; dutyCycle <= 1.0; dutyCycle += 0.05) { // Initialize dutyCycle as 0.0 and gradually increase by 0.05 until it is greater than 1.0
        ...
        Thread.sleep(100);  // Wait for 100 milliseconds to allow for a gradual increase
    }
    ...
    Thread.sleep(1000);  // Keep it off for 1 second before ending the program (doesn't really change anything)
  } // Close main method
} // Close public class LEDBrightness
