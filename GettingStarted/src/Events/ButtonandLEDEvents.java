...
public class ButtonandLEDEvents {
   ...
   static int greenButtonPresses = 0; // Tracks the number of presses for the Green Button (Player 2)
   static boolean gameRunning = true; // Boolean variable to indicate if the game is still running or not
   public static void main(String[] args) throws Exception {
       ...
       // Open connections to buttons and LEDs (timeout if not connected in 1 second)
       redButton.open(1000);
